...
CREATE TABLE usuarios (
    ...
    tipo_usuario ENUM('aluno', 'professor', 'admin', 'ceo') NOT NULL DEFAULT 'aluno',
...
VALUES (
    'Administrador',
    'admin@email.com',
    '$2b$10$Gd43KpT3TqXfADMkgJzA0eNx4mZndtNiKebKlZ/9kedHbQTBNOM7O',
    'admin'
);
...
VALUES (
    'Professores',
    'professores@sesisenai.com',
    '$2b$10$tIuGXFrsRqTMuqu7zVri1uvz892EdX3LC3Uu3uukaGL31rRQAYK/u',
    'professor'
);
